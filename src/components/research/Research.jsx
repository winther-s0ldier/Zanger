...
function Research() {
  ...
  const handleDeleteTask = async (taskId) => {
    try {
      const response = await fetch(
       `http://54.85.178.85/api/tasks/${taskId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleDeleteUpdate = async (updateId) => {
    try {
      const response = await fetch(
        `http://54.85.178.85/api/updates/${updateId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${user.token}`,
  ...
  const fetchPriorityTasks = async () => {
    try {
      const response = await fetch("http://54.85.178.85/api/tasks", {
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
      });
  ...
  const fetchRecentUpdates = async () => {
    ...
    try {
      const response = await fetch(
        `http://54.85.178.85/api/updates/recent?email=${loggedinuser.user.email}`,
        {
          headers: {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch("http://54.85.178.85/api/search", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${user.token}`,
                                ...
                                {(result.type === "File" ||
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      if (result.type === "File") {
                                        window.open(
                                          `http://54.85.178.85/uploads/${result.path}`
                                        );
                                      } else if (
                                        result.type === "Web" &&
                                        result.url
